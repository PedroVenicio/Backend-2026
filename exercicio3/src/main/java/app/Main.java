...
public class Main {
    ...
    public static void main() {
        ...
        try {
            ...
            System.out.println("Aplicar rendimento de -10%? true");

        } catch (IllegalArgumentException e) {

            System.out.println("Aplicar rendimento de -10%? false (" + e.getMessage() + ")");

        } finally {

            System.out.println("Fim da tentativa de aplicação.");
